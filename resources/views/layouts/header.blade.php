  <a href="dashboard" class="logo">
      <span class="logo-mini"><b>AS</b><!-- LT --></span>
      <span class="logo-lg"><b>PT ANEKA SARIVITA</b><!-- LTE --></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('file/logo.jpeg') }}" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="{{ url('admin/ubah_password') }}" class="btn btn-default btn-flat" ></i>Ubah Password</a>
                </div>
